...
Calculamos la transformada de $f_{(x)}$:
$$
...
$$
y_1 =\left[ 0 + \mathcal{L}^{-1}\left\{\frac{1}{(z^2+1)( z^2 - 3z + 2)}\right\}_{(t)}\right]  u(t) +  \left[  0 - \mathcal{L}^{-1}\left\{\frac{1}{(z^2+1)( z^2 - 3z + 2)}\right\}_{(-t)} \right] u(-t)
$$
