...
\fancyfoot[C]{Mazzi, María Clara \hspace{1cm} Storani, Miguel Ignacio}
\fancyfoot[L]{2019}
%---------------------------------------------------------
...
Esta propiedad sólo se cumple para toda función que cumpla $f(t) = 0 \ \forall t < 0$, por lo que se puede utilizar la transformada unilateral de Laplace.
